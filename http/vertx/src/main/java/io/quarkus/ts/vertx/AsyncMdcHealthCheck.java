...
@Liveness
public class AsyncMdcHealthCheck implements AsyncHealthCheck {
    ...
    public Uni<HealthCheckResponse> call() {
        ...
        LOGGER.info("Async Health check 1 - " + Thread.currentThread().getName());

        return Uni.createFrom().item(HealthCheckResponse.up("async-mdc-health-check"));
    }
}
